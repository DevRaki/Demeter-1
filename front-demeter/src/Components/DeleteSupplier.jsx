...
export default function DeleteSupplier({ onDelete}) {
    ...
    const confirmDelete = () => {
        if (supplyToDelete) {
          deleteSupplier(supplyToDelete.ID_Supplier);
  ...
  return (
    <div>
    <button type="button" class="btn  btn-icon btn-secondary" onClick={() => handleOpen()}><i data-feather="camera"><AiFillDelete/> </i></button>
    <Modal
      open={open}
      onClose={handleClose}
    ...
    >
      ...
      <div className="modal-overlay" onClick={handleClose}></div>
            ...
            <div className="modal-container bg-white p-6 rounded shadow-md text-center ">
                ...
                <p className="deleteText">¿Estás seguro de que deseas eliminar este proveedor?</p>
